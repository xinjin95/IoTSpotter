...
def train_embedding():
    ...
    # model.fit(x_train, y_train, epochs=20, batch_size=200, validation_data=(x_validation, y_validation))
    ...
    model_save_path = "../data/classifiers/bilstm_embedding_final_precision.h5"
    checkpoint = ModelCheckpoint(model_save_path, monitor='val_precision', verbose=0, save_best_only=True,
    ...
    # model.save("../data/classifiers/bilstm_embedding_final.h5")

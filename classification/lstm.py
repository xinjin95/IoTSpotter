...
from classification.keras_utility import glove_dictionary_load
...
def train_embedding():
    ...
    bidirectional_layer = LSTM(units=300, return_sequences=True)
    ...
    model.save("../data/classifiers/lstm_embedding_final.h5")
